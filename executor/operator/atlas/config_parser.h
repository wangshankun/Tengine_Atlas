...
public:
    ...
    int GetStringValue(const std::string &name, std::string &value);
    // Get the int value by key name
    int GetIntValue(const std::string &name, int &value);
    // Get the unsigned int value by key name
    int GetUnsignedIntValue(const std::string &name, unsigned int &value);
    // Get the bool value by key name
    int GetBoolValue(const std::string &name, bool &value);
    // Get the float value by key name
    int GetFloatValue(const std::string &name, float &value);
    // Get the double value by key name
    int GetDoubleValue(const std::string &name, double &value);
    // Get the vector by key name, split by ","
    int GetVectorUint32Value(const std::string &name, std::vector<uint32_t> &vector);
